...
export const templateTabs: TemplateTab[] = [
  ...
  },
  {
    ...
    templates: [
      ...
      {
        slug: "demand-mining-pipeline",
        title: { en: "Demand Mining Automation Pipeline", zh: "需求挖掘自动化流水线" },
        summary: {
          en: "A multi-step cron pipeline that discovers rising keywords, validates them against community signals, and delivers a ranked opportunity list each morning.",
          zh: "一条多步骤 cron 流水线：发现上升关键词、用社区信号验证、每天早上输出一份排好优先级的机会清单。",
        },
        difficulty: { en: "Advanced", zh: "高级" },
        time: { en: "45 min", zh: "45 分钟" },
        risk: { en: "Medium risk", zh: "中风险" },
        tags: { en: ["Research", "Automation", "Pipeline"], zh: ["调研", "自动化", "流水线"] },
        channels: { en: ["Telegram", "Email"], zh: ["Telegram", "邮件"] },
        recommendedFor: {
          en: "Solo builders or product teams who want a repeatable system for finding underserved demand before committing to a direction.",
          zh: "适合希望在确定方向之前，用一套可重复运行的系统持续发现未被满足需求的独立开发者或产品团队。",
        },
        cta: { label: { en: "Build the pipeline", zh: "搭建这条流水线" }, href: "/learn", variant: "secondary" },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    templates: [
      ...
      {
        slug: "multi-agent-feishu-setup",
        title: { en: "Multi-Agent Feishu Collaboration Setup", zh: "多 Agent 飞书协作配置" },
        summary: {
          en: "Configure multiple independent agents with separate workspaces and route each Feishu account to the right brain using bindings.",
          zh: "为每个机器人配置独立工作区，通过 bindings 把每个飞书账号精准路由到对应的 Agent 大脑。",
        },
        difficulty: { en: "Advanced", zh: "高级" },
        time: { en: "40 min", zh: "40 分钟" },
        risk: { en: "Medium risk", zh: "中风险" },
